...
init_per_testcase(TestCase, Config)
  when TestCase == delete_bearer_request_resend;
    ...
    Config;
init_per_testcase(delete_beaerer_requests_multi, Config) ->
    init_per_testcase(Config),
    Config;
...
end_per_testcase(delete_beaerer_requests_multi, Config) ->
...
delete_beaerer_requests_multi(Config) ->
    Cntl = whereis(gtpc_client_server),
